var mtjwxsdk = function (e) {
  ...
  var o, t, n = "1.7.2", h = {}, g = {
    ...
    enabledEvents: {
      app: [],//["show", "hide", "error"]
      page: ["show", "hide"],
      share: ["action"],// ["action", "success", "fail"]
      event: "*"
    },
    storageKeys: {
      appId: "mtj_appid",
    ...
    if (e.data = e.data || {},
      ...
      e.data.rqc = ++c,
      t = e.data,
      !(JSON.stringify(t).length <= p.maxRequestDataLength))
      return c-- ,
      ...
      return o.request({
        ...
        fail: function (e) {
          n.data.rtc = (n.data.rtc || 0) + 1,
            n.data.rtc <= p.maxRequestRetryCount ? setTimeout(function () {
    ...
    var unionID = m(p.storageKeys.unionID);
    if (a(unionID, "String") && unionID.length > 0)
    {
    ...
    if (!("*" !== p.enabledEvents[e.et] && p.enabledEvents[e.et].indexOf(e.en) < 0)) {
      ...
      var n = m(p.storageKeys.unionID);
      if (a(n, "String") && n.length>0){
        t.data.unionID=n;
        f(t);
      }
      else
    ...
    try {
      ...
      return console.error("请把mtj-wx-sdk.config.js文件拷贝到utils目录中"),
        t = new Promise(function (e) {
          return 0
        }
        )
    }
    return t = e && e.openAppId ? (h.key = e.openAppId,
      h.appId=e.appId,
      h.sid = r(),
      h.rqc = 0,
      Promise.all([d(), new Promise(function (t, e) {
        var n = m(p.storageKeys.userInfo)
          , r = a(n, "Object") ? n : {};
        o.getSetting({
          success: function (e) {
        ...
        })) : (console.error("请设置app.json文件中的ext.openAppId字段"),
    ...
    onShow: function () {
      ...
      return g.aso.scene = "" + (t.scene || ""),
        t.referrerInfo && t.referrerInfo.appId ? g.aso.referrerInfo = t.referrerInfo : delete g.aso.referrerInfo,
        g.aso.path = t.path || "",
        ...
        S().then(function () {
          ...
          e ? g.aso.shareInfo = e : delete g.aso.shareInfo,
            y(Object.assign({
              et: "app",
              en: "show"
            }, g))
    ...
    onLoad: function (t) {
      h.path = this.route,
        h.query = Object.keys(t).map(function (e) {
          return {
            key: e,
            value: t[e]
          }
    ...
    onShareAppMessage: function (e) {
      var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}
        , n = m(p.storageKeys.shareCount);
      n = (Number.isInteger(n) ? n : 0) + 1,
        v(p.storageKeys.shareCount, n);
      var r = {
        cnt: n,
        from: e.from,
        path: t.path || ""
      ...
      t.path = (i = t.path || h.path,
        s = "mtj_shuuid",
        u = f,
        c = 0 < (i = i.replace(new RegExp(s + "=[^&]*", "g"), "").replace(/(\?|&)&/g, "$1").replace(/(\?|&)$/g, "")).indexOf("?") ? "&" : "?",
    ...
    trackEvent: function (e) {
      ...
      var n = Object.keys(r).filter(function (e) {
        return a(n = e, "String") && /^[a-z0-9_]{1,32}$/.test(n) && (t = r[e],
          a(t, "String") || a(t, "Number"));
        var t, n
      }).map(function (e) {
        return {
          key: "" + e,
    ...
    setUserInfo: function () {
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}
        ...
        , r = e.openId;
      return S().then(function () {
        var e = m(p.storageKeys.userInfo)
          , t = a(e, "Object") ? e : {};
        return s(n) && (t.tel = g.user.tel = n.substr(n.length - 11)),
          u(r) && (t.openId = g.user.openId = r),
          (t.tel || t.openId) && v(p.storageKeys.userInfo, t),
          a(n, "Undefined") || s(n) ? a(r, "Undefined") || u(r) ? void 0 : Promise.reject(new Error("openid不合法")) : Promise.reject(new Error("手机号不合法"))
      })
    }
  }, O = function (e, t, n) {
    var r = t[e];
